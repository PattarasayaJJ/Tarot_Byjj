...
className="absolute top-6 right-6 text-sm bg-purple-900 bg-opacity-50 text-white px-4 py-2 rounded-full hover:bg-opacity-70 transition"
  ...
  className={`
    ...
    rounded-3xl
    border-2
    bg-gradient-to-tr from-purple-900 via-pink-700 to-indigo-900
  ...
  `}
  style={{
    boxShadow: '0 0 15px 4px rgba(255, 182, 193, 0.7)', // pink glow
    animation: 'float 4s ease-in-out infinite',
  }}
>
  <div className="absolute inset-0 bg-gradient-to-r from-purple-400 via-pink-500 to-indigo-400 opacity-30 blur-xl animate-animate-glow"></div>
