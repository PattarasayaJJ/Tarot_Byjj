    ...
    <p className="font-semibold text-base text-yellow-300 mb-6 ">        {spreadTypes.find(s => s.id === spreadType)?.name || ''}
      ...
      <div className="flex flex-col gap-5 mb-5">
        {selectedCards.map((card, i) => (
          <div
            key={card.id}
className="bg-gradient-to-br from-purple-950 via-purple-900 to-gray-900 bg-opacity-90 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-white/10"
          >
